...
class UserManager(BaseUserManager):
	# 필수로 필요한 데이터를 선언
    def create_user(self, user_id, people, store_id, soju_quantity, beer_quantity, makguli_quantity, alcohol = 0, password = None):
        if not user_id:
    ...
    def create_superuser(self, user_id, people, store_id, soju_quantity, beer_quantity, makguli_quantity, alcohol = 0, password=None):
...
class User(AbstractBaseUser):
    ...
    REQUIRED_FIELDS = ['people', 'store_id', 'soju_quantity', 'beer_quantity', 'makguli_quantity']
